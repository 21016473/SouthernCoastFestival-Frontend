...
export default function MUIDrawer() {
    ...
    const menuItems = [
        { text: 'Manage Events', disabled: true, tooltip: 'Feature coming soon'}, 
        { text: 'Manage Users', disabled: true, tooltip: 'Feature coming soon'}, 
        { text: 'Log Out', diabled: false, tooltip: '' }
    ]
    ...
    return (
        <div>
            ...
            >
                ...
                <Typography className="admin-text">Admin</Typography>
